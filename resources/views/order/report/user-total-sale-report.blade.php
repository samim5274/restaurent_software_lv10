...
<html lang="en">
<head>
    <title>User Sale Report | {{ $company->name ?? 'Undefined' }}</title>
           ...
           @include('layouts.message')
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <h2>User Wise Total Sale Report</h2>
                            <ul class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{url('/')}}">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="{{url('/order-details')}}">Order</a></li>
                                <li class="breadcrumb-item" aria-current="page">User-Reports</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row ">
                <div class="col-lg-12 col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('filter-user-total-sale') }}" target="_blank" method="GET" class="row g-3 align-items-end">
