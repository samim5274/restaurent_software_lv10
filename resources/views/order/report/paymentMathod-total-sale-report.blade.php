...
<html lang="en">
<head>
    <title>Payment Mathod Total Sale Report | {{ $company->name ?? 'Undefined' }}</title>
           ...
           @include('layouts.message')
            ...
            <div class="page-header">
                <div class="page-block">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <h2>Payment Mathod Wise Total Sale Report</h2>
                            <ul class="breadcrumb">
            ...
            <div class="row ">
                <div class="col-lg-12 col-md-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('payment-mathod-total-sale') }}" target="_blank" method="GET" class="row g-3 align-items-end">
                                ...
                                <!-- Payment mathod -->
                                <div class="col-md-12">
                                    <select name="pay_id" id="pay_id" class="form-select" required>
                                        <option disabled selected>-- Select Payment Mathod --</option>
                                        @foreach($paymentMathods as $val)
                                ...
                                <tbody>
                                    @forelse($orders as $val)                                        
                                        <tr>
                                            ...
                                            <td class="text-center">{{ ($val->payment->name) }}</td>
